            ...
            <div>
                <div style={{background:'white',width:'1100px',height:'300px'}}>
                    ...
                    <div style={{width:'900px',height:'60px',marginTop:'50px'}}>
                        <span style={{marginLeft:'200px'}}>用户名<input type='text' style={{width:'250px',height:'30px',border:'1px solid black'}}/></span>
                    </div>
                    {/* <br/> */}
                    <div style={{width:'900px',height:'60px'}}>
                        <span style={{marginLeft:'200px'}}>密码<input type='password' style={{width:'250px',height:'30px',border:'1px solid black'}}/></span>
                    </div>
                    <div style={{width:'900px',height:'60px'}}>
                        <Link to='/home'><button style={{background:'blue',color:'white',width:'60px',height:'40px',marginLeft:'200px',border:'blue'}}>登录</button></Link>
